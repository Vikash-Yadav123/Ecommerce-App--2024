...
const CreateProduct = () => {
    ...
    // CRAETE PRODUCT
    const handleCraeteProduct = async (e) => {
        e.preventDefault();
        try {
    ...
    return (
        <Layout title="Create Product - Ecommerce"
            description="Create and manage product for the ecommerce app"
            keywords="admin, dashboard, ecommerce, product"
        >
            <div className='container-fluid  mt-4'>
                <div className='row'>
                    ...
                    <div className='col-md-9 mt-2 ps-4'>
                        <h3 className='text-center mb-2'>Create Product</h3>
                        <div className='w-75'>
                            <form onSubmit={handleCraeteProduct}>
                                <Select
                                    showSearch
